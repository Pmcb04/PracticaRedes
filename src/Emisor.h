...
class Emisor {
   ...
   public:
		...
		// operacion a realizar en el protocolo y el modo del maestro (Sondeo o selecci�n)
		void Maestro(HANDLE &PuertoCOM);

		// Metodo para el escalvo en el protocolo, el modo del esclavo (Sondeo o selecci�n
		void Esclavo(HANDLE &PuertoCOM);

		// metodo para maestro de modo seleccion
		void maestroSeleccion(HANDLE &PuertoCOM);

		// metodo para maestro de modo selecci�n
		void maestroSondeo(HANDLE &PuertoCOM);

		// metodo para esclavo de modo selecci�n
		...
		// se espera a la espera de una trama de confirmaci�n (Trama ACK)
